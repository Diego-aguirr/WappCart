...
import { useCart } from '@/features/cart/provider/CartProvider'
  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <a href="/menu" className="inline-block bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700">
          Ver Menú
        </a>
      </div>
    )
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form action={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="customerName" className="block text-sm font-medium mb-2">Nombre completo *</label>
